...
import { Menu, X, Home, Settings, List, Bell, Package } from 'lucide-react';
      ...
      >
        ...
        <nav className="px-4 py-6">
          <ul className="space-y-4">
            ...
            <li>
              <Link href="/inventory" className="flex items-center px-4 py-2 text-gray-700 dark:text-gray-300 rounded-md hover:bg-green-50 dark:hover:bg-green-900/20 hover:text-green-700 dark:hover:text-green-500">
