...
import { Bell, User, Share2, Save, Monitor } from 'lucide-react';
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              <Card>
                <CardContent className="pt-6">
                  <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-4">Informations</h3>
                  <div className="space-y-4">
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">15 mars 2023</p>
                    </div>
                    <div className="pt-4">
